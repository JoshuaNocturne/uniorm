...
class UNIORM_ODBC_API odbc_error : public backend::backend_error {
public:
...
UNIORM_ODBC_API std::vector<odbc_error::diagnostic> collect_diagnostics(
...
UNIORM_ODBC_API void throw_if_error(SQLRETURN rc, SQLSMALLINT handle_type,
